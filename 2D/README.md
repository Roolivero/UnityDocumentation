...
This folder contains concepts that are specific to 2D game development in Unity.

## Suggested Reading Order

1. [Sprites and Rendering](SpritesAndRendering.md)
2. [Sorting Layers](SortingLayers.md)
3. [Sprite Sort Point](SpriteSortingPoint.md)
